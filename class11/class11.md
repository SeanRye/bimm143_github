...
2.  A **pLDDT** score: that rells us how confident the model is for a
...
https://github.com/sokrypton/ColabFold?tab=readme-ov-file \> \[ Figure
from AlhpaFold here!
...
analysis than just reviewing the structures in Mol-star
...
Note: I wasn’t able load the heatmap since I’m unable to install the
bio3dview package, preventing me from loading the code since I can’t
define the `pdbs` variable
