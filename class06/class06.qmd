...
addnew(c(100,1),100)
```
If we write our function with input arguments having no default value then the user will be required to set them when they use the function. We can give our input aguments "default" values by setting them equal to some sensible value - e.g. y=1 int he `addnew()`
