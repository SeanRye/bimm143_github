---
title: "Class 08: Cancer MiniProject"
...
ggplot(wisc.pr$rotation) + 
  aes(PC1,
      order( rownames(wisc.pr$rotation/0), PC1) ) + 
  geom_col()
```
...
table(grps)
```
I want to know how the clustering in `grps` with values of 1 or 2 correspond the exper `diagnosis`
